class StringConstants {
  ...
  static const String apiFailureMsg = "Unable to process your request, please try again later";
  static const String formValidationMsg = "Please fill up the above form properly";
}
